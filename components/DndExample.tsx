                                                                    ...
                                                                    >
                                                                        <div className="px-2 py-2 border bg-white rounded-lg h-full text-lg">
                                                                            <div className="flex justify-end items-center right-0">
                                                                                <button className="p-1" onClick={handleOpenConfirmModal}>
                                                                                ...
                                                                                {/* <ConfirmModal isOpen={isConfirmModalOpen} onClose={handleCloseConfirmModal} onConfirm={() => handleConfirm(component.id)} /> */}

                                                                                {
                                                                                    isConfirmModalOpen && <div className="fixed z-10 inset-0 overflow-y-auto">
                                                                                        <div className="flex items-center justify-center min-h-screen">
                                                                                            <div className="relative bg-white w-96 mx-auto p-6 rounded-lg shadow-lg">
                                                                                                <div className="flex justify-between items-center">
                                                                                                    ...
                                                                                                    <button onClick={handleCloseConfirmModal} className="text-gray-500 hover:text-gray-700 focus:outline-none">
                                                                                                ...
                                                                                                <div className="mt-6 flex justify-end">
                                                                                                    <button onClick={handleCloseConfirmModal} className="mr-2 px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 focus:outline-none">
                                                                                                        Cancel
                                                                                                    </button>
                                                                                                    <button onClick={() => handleConfirm(component.id)} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none">
                                                                                                        OK
                                                                                                    </button>
                                                                                                </div>
                                                                                            </div>
